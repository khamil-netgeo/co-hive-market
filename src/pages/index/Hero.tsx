        ...
        <div>
          ...
          <div className="mt-6 flex flex-wrap gap-3">
            <Button variant="hero" size="lg" asChild>
              <a href="/catalog" aria-label="Browse products"><ShoppingBag className="h-4 w-4" /> Browse Products</a>
            </Button>
            <Button variant="secondary" size="lg" asChild>
              <a href="/plans" aria-label="Explore services"><Wrench className="h-4 w-4" /> Explore Services</a>
            </Button>
            <Button variant="outline" size="lg" onClick={onGetStarted}>
              Become a Vendor
            </Button>
            <Button variant="ghost" size="lg" asChild>
              <a href="/riders" aria-label="Become a rider">Become a Rider</a>
            </Button>
          </div>
