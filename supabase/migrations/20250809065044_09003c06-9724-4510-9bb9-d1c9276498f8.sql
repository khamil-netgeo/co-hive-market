...
create policy if not exists "Vendors view own payouts" on public.payouts
...
create policy if not exists "Vendors create payout requests" on public.payouts
...
create policy if not exists "Vendors cancel own requested payouts" on public.payouts
...
create policy if not exists "Admins manage payouts" on public.payouts
