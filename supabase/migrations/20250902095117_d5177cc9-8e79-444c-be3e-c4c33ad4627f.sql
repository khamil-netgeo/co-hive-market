...
-- First, let's add a unique constraint on the combination of buyer_user_id and vendor_id
-- We use a partial unique index to handle the nullable columns properly
CREATE UNIQUE INDEX CONCURRENTLY idx_chat_threads_buyer_vendor_unique 
